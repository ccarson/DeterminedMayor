CREATE TABLE [dbo].[FedTransXD3] (
    ...
    [PONumber]        INT             CONSTRAINT [DF_FedTransXD3_PONumber] DEFAULT ((0)) NOT NULL,
    [POLine]          INT             CONSTRAINT [DF_FedTransXD3_POLine] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [FedTransXD3_INDEX01] PRIMARY KEY CLUSTERED ([ID] ASC)
);
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [FedTransXD3_INDEX02]
    ON [dbo].[FedTransXD3]([HeaderID] ASC, [LineNum] ASC, [CreatedDate] ASC, [ID] ASC);
