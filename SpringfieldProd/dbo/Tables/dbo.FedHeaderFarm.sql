CREATE TABLE [dbo].[FedHeaderFarm] (
    ...
    CONSTRAINT [FedHeaderFarm_INDEX01] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [FedHeaderFarm_INDEX02]
    ON [dbo].[FedHeaderFarm]([Serial] ASC, [GunType] ASC, [Manufacturer] ASC);
