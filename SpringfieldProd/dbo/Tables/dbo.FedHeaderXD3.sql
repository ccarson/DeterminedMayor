CREATE TABLE [dbo].[FedHeaderXD3] (
    ...
    CONSTRAINT [FedHeaderXD3_INDEX01] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [FedHeaderXD3_INDEX02]
    ON [dbo].[FedHeaderXD3]([Serial] ASC, [GunType] ASC, [Manufacturer] ASC);
