...
CREATE PROCEDURE [dbo].[sasp_InventoryAgingRawWithStdCost] 
AS
...
SELECT p.SPRNUM, 'N', 0, 0, '1753-01-01', 0, 0, 0, 0
FROM parts p
...
, p.[RAW] as TotalQuan
  ...
  , ia.WOPONumber
  , ia.Quan
  --2017-01-18 MRM Laura wants Parts.CostFin instead of the previously saved cost.
  --  I'd think this should be CostRaw here, but whatever...
  --, ia.StandardCost
